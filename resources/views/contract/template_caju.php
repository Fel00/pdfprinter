...
<p><strong>CONTRATADA: <?=$config['nome']?></strong>, pessoa jurídica de direito privado, inscrita no CNPJ sob n. <?=$config['cnpj']?>, com sede na <?=$config['endereco']?>, neste ato representada pela sócia <?=$config['representante']?>.</p>
...
<p><strong>Cláusula 1ª.</strong> É objeto do presente contrato a prestação pela CONTRATADA à CONTRATANTE dos serviços de fornecimento de Buffet para <?=$cardapio['quantidade_pessoas']?> pessoas.</p>
<br>

<p><strong><?=$tipoBufet?></strong></p>

<?php if (!empty($cardapio['mesa_fixa'])): ?>
<p><strong>Mesa fixa – <?=$tipoBufet?></strong></p>
<?php foreach ($cardapio['mesa_fixa'] as $item): ?>
<p><?=$item?></p>
<?php endforeach; ?>
<?php endif; ?>

<?php if (!empty($cardapio['volantes'])): ?>
<p><strong>Volantes</strong></p>
<?php foreach ($cardapio['volantes'] as $item): ?>
<p><?=$item?></p>
<?php endforeach; ?>
<?php endif; ?>

<?php if ($cardapio['bebidas']): ?>
<p>• Bebidas não alcoólicas</p>
<?php endif; ?>

<?php if (!empty($cardapio['loucas'])): ?>
<p>• Louças e material para realizarmos o serviço</p>
<p><?=$cardapio['loucas']?></p>
<?php endif; ?>

<?php if (!empty($cardapio['equipe'])): ?>
<p>• Equipe</p>
<p><?=$cardapio['equipe']?></p>
<?php endif; ?>
...
<p><strong><?=$config['banco']?><br>
AG <?=$config['agencia']?><br>
CONTA <?=$config['conta']?></strong></p>
<p><strong>PIX: <?=$config['pix']?></strong></p>
<p><strong><?=$config['representante']?><br>
CNPJ: <?=$config['cnpj']?></strong></p>
<br>
...
<div style='text-align: center; margin-top: 200px;'>
    ...
    <img src='img/assinatura1.png' alt='Assinatura Contratada' style='width: 290px; height: auto; margin: 0px 0;'>
    <p>_____________________________________</p>
...
<div style='text-align: center; margin-top: 50px;'>
    <img src='<?=$config['logo']?>' alt='Logo Caju' style='width: 200px; height: auto;'>
</div>
